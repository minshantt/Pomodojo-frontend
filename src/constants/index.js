...
<section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
  <div className={`flex-1 ${styles.flexStrt} flex-col xl:px-0 sm:px-16 px-6 `}>
    <div className={`flex flex-row items-center py-[6px] px-4 bg-timer-gradient rounded-[10px] mb-2`}>
    ...
    <p className={`${styles.paragraph} max-w-[470px] mt-5 text-dimwhite`}>
      ...
      Boost your efficiency and achieve your goals.
    </p>
  </div>
